      ...
      return $order_summary;
		...
		if ( !empty( $order_summary ) ) {
			...
			foreach ( $order_summary as $order ) {
				...
				$wcfm_orders_json_arr[$index][] = apply_filters( 'wcfm_order_date_display', $the_order->get_date_created()->date_i18n( wc_date_format() ), $order->order_id, $order );
