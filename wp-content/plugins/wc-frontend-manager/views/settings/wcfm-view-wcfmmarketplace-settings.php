...
<?php if( $wcfm_is_allow_billing_settings = apply_filters( 'wcfm_is_allow_billing_settings', true ) ) { ?>
	...
	<div class="wcfm-container">
		...
		<div id="wcfm_settings_form_payment_expander" class="wcfm-content">
			...
			<div class="wcfm_vendor_settings_heading"><h2>Commission</h2></div>
			<div class="wcfm_clearfix"></div>
			<div class="store_address">
				<p class="store_name wcfm_title wcfm_ele"><strong>Commission </strong></p>
				
				<?php $cms=get_user_meta(get_current_user_id(), 'wcfmmp_profile_settings'); 
				
				$xx = $cms[0]['commission']['commission_percent'];
			...
			<div class="wcfm_vendor_settings_heading"><h2>Payment</h2></div>
			<div class="wcfm_clearfix"></div>
			<?php
