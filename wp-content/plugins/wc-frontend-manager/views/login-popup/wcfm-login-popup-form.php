...
<form id="wcfm_login_popup_form" class="wcfm_popup_wrapper">
	...
	<table>
		<tbody>
		  ...
		  <?php do_action( 'wcfm_product_login_popup_begin' ); ?>
			...
			<tr>
				<td>
					<p class="wcfm_login_popup_form_label wcfm_popup_label"><?php _e( 'Username', 'wc-frontend-manager' ); ?></p>
	...
	<a style="color:#17a2b8;" class="wcfm_login_popup_registration_link wcfm_popup_link" target="_blank" href="<?php echo get_permalink( wc_get_page_id( 'myaccount' ) ); ?>"><?php _e( 'No account yet! Click here to register', 'wc-frontend-manager' ); ?></a>
