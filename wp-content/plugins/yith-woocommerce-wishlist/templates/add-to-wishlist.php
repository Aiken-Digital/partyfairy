	...
	<?php if( ! ( $disable_wishlist && ! is_user_logged_in() ) ): ?>
	    ...
	    <div class="yith-wcwl-wishlistaddedbrowse hide" style="display:none;">
	       <!--  <span class="feedback"><?php //echo $already_in_wishslist_text ?></span> -->
	        <a href="<?php echo home_url('wishlist'); ?>" rel="nofollow" title="Already in Wishlist" id="bt-ic-w-pf">
	            <?php //echo apply_filters( 'yith-wcwl-browse-wishlist-label', $browse_wishlist_text )?>

	            <img src="<?php echo get_template_directory_uri()  ?>/icon/love.png" id="ic-w-pf">
	        </a>
