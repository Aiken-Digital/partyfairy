...
class WCFMu_Vendor_Verification {
  ...
  function wcfm_vendor_auth_requests() {
	...
	function wcfmu_vendor_verification_user_setting_block( $user_id ) {
		?>
		<a href="<?php echo get_wcfm_profile_url(); ?>#sm_profile_manage_form_verification_head" class="page_collapsible page_collapsible_dummy"><label class="fa fa-angellist"></label><?php _e( 'Verification', 'wc-frontend-manager-ultimate' ); ?><span></span></a>
		<div class="wcfm-container">
	...
	function wcfmu_vendor_verification_user_setting_header( $user_id ) {
		echo '<a id="wcfm_verification_settings" class="add_new_wcfm_ele_dashboard text_tip" href="'.get_wcfm_profile_url().'#sm_profile_manage_form_verification_head" data-tip="' . __( 'Verification', 'wc-frontend-manager-ultimate' ) . '"><span class="fa fa-angellist"></span><span class="text">' . __( 'Verification', 'wc-frontend-manager-ultimate' ) . '</span></a>';
	}
	...
	function wcfmu_vendor_verification_user_profile_fields() {
		...
		?>
		<div class="page_collapsible profile_manage_verification" id="sm_profile_manage_form_verification_head"><label class="fa fa-angellist"></label><?php _e( 'Verification', 'wc-frontend-manager-ultimate' ); ?><span></span></div>
		<div class="wcfm-container">
