  ...
  function wcfm_product_custom_visibility_options( $visibility_options ) {
	...
	function get_wcfm_custom_field_display_data( $product_id, $wcfm_product_custom_field ) {
		...
		if( !empty( $wcfm_product_custom_block_fields ) && !in_array( $product_type, $exclude_product_types ) ) {
			...
			if( apply_filters( 'wcfm_is_allow_custom_field_dissplay_as_table', false ) ) { $display_data .= "<table class='wcfm_custom_field_display_table'><tr>"; }
			foreach( $wcfm_product_custom_block_fields as $wcfm_product_custom_block_field ) {
				...
				if( apply_filters( 'wcfm_is_allow_custom_field_dissplay_as_table', false ) ) { $display_data .= "<td>"; }
				...
				if( apply_filters( 'wcfm_is_allow_custom_field_dissplay_as_table', false ) ) { $display_data .= "<br />"; }
				$display_data .= "<span class='wcfm_custom_field_display_value'>" . $field_value . "</span><br />";
				if( apply_filters( 'wcfm_is_allow_custom_field_dissplay_as_table', false ) ) { $display_data .= "</td>"; }
			}
			if( apply_filters( 'wcfm_is_allow_custom_field_dissplay_as_table', false ) ) { $display_data .= "</tr></table>"; }
			$display_data .= '</div>';
		}
		return $display_data;
	}
