	...
	<div class="wcfm-container">
		<div id="orders_details_notes_expander" class="wcfm-content">
			...
			<?php if( $view_add_order_notes = apply_filters( 'wcfm_add_order_notes', true ) ) { ?>
				<div class="add_note">
					<h2><?php _e( 'Add note', 'wc-frontend-manager-ultimate' ); ?> <span class="fa fa-question-circle-o img_tip" data-tip="<?php _e( 'Add a note for your reference, or add a customer note (the user will be notified).', 'wc-frontend-manager-ultimate' ); ?>"></span></h2>
					<div class="wcfm-clearfix"></div>
					<p>
