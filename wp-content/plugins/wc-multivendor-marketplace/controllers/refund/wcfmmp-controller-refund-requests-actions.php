	  ...
	  if( isset( $wcfm_refund_manage_form_data['refunds'] ) && !empty( $wcfm_refund_manage_form_data['refunds'] ) ) {
	  	...
	  	// WCFM form custom validation filter
			...
			foreach( $refunds as $refund_id ) {
				...
				$refund_update_status = $WCFMmp->wcfmmp_refund->wcfmmp_refund_status_update_by_refund( $refund_id );
	  ...
	  if( isset( $wcfm_refund_manage_form_data['refunds'] ) && !empty( $wcfm_refund_manage_form_data['refunds'] ) ) {
	  	...
	  	// WCFM form custom validation filter
			...
			foreach( $refunds as $refund_id ) {
				...
				// Update refund status
				$WCFMmp->wcfmmp_refund->wcfmmp_refund_status_update_by_refund( $refund_id, 'cancelled' );
