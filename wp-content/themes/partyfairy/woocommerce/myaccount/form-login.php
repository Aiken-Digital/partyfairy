			...
			<?php do_action( 'woocommerce_register_form_start' ); ?>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="password" placeholder="Enter Your Password Again" id="userpasswordconfirm" name="userpasswordconfirm" required>
                </div>
                <div class="form-group">
                  <div class="m-b-20"><span class="control">
                      <input id="rmbme" name="rmbme" type="checkbox"></span>
